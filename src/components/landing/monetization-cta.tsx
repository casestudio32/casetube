  ...
  return (
    <section className="relative w-full bg-[#080808] py-20 px-8 md:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-0">
        ...
        >
          {/* Person image — centered in the right half */}
          <div className="relative w-[380px] md:w-[460px] h-[500px] md:h-[580px]">
            <Image
              src="/Images/Man.png"
            ...
            <div
              ...
              style={{ height: "140px", background: "linear-gradient(to top, #080808 30%, transparent)" }}
            />
          </div>

          {/* Card 1 — Subscribers — hugging top-left shoulder of person */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.45, duration: 0.5 }}
            className="absolute rounded-2xl px-4 py-3.5 min-w-[185px]"
            style={{ top: "10%", left: "4%", ...glassCard }}
          >
          ...
          {/* Card 2 — Watch Hours — bottom-right overlapping the person's lower body */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            className="absolute rounded-2xl px-4 py-3.5 min-w-[185px]"
            style={{ bottom: "22%", right: "2%", ...glassCard }}
          >
            <div className="flex items-center gap-2 mb-2">
