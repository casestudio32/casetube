...
const NAV = [
  ...
  { href: "/trends", icon: Icons.trends, label: "Trend Finder" },
  { href: "/competitors", icon: Icons.competitors, label: "Competitors" },
  { href: "/my-channel", icon: Icons.channel, label: "My Channel" },
  { href: "/thumbnail", icon: Icons.thumbnail, label: "Thumbnail Maker" },
